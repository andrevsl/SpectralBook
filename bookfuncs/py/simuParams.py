...
class SimuParam():
    ...
    def __init__(self):
        self.emconst= {"e0": 8.854223e-12,   #Permissividade absoluta do meio Free space
    ...
    def set_HsinP(self,Fs):
        ...
        self.par.loc['HSinP','Lamb']=1/np.sqrt(self.emconst['e0']*self.emconst['u0'])/self.par.loc['HSinP','f']# Frequency
    ...
    def set_HSinN(self,Fs):
        ...
        self.par.loc['HSinN','Lamb']=1/np.sqrt(self.emconst['e0']*self.emconst['u0'])/self.par.loc['HSinN','f']# Frequency
    ...
    def set_Gau(self,Fs):
        ...
        self.par.loc['Gau','Lamb']=1/np.sqrt(self.emconst['e0']*self.emconst['u0'])/self.par.loc['Gau','f']# Frequency
    ...
    def set_TD_CST(self,Name,t,I1,I11,I21):
        ...
        # self.par.loc[Name,'Lamb']=1/np.sqrt(self.emconst['e0']*self.emconst['u0'])/self.par.loc[Name,'f']# Frequency
