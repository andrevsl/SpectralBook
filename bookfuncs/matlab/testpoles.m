...
z = roots([Lp*Ld, (Rp*Ld-Z0*Lp-Z0*Ld), (Ld/Cp-Z0*Rp) ,Z0/Cp])
p = roots([Lp*Ld, (Rp*Ld+Z0*Lp+Z0*Ld), (Ld/Cp+Z0*Rp) ,Z0/Cp])
...
z1 = zeors1_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)
z2 = zeors2_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)
z3 = zeors3_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)


p1 = poles1_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)/(2*pi)
p2 = poles2_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)
p3 = poles3_func(Lp_val, Ld_val,Rp_val,Z0,Cp_val)